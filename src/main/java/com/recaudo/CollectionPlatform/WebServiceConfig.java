...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean<MessageDispatcherServlet> messageDispatcherServlet(ApplicationContext applicationContext) {
        ...
        return new ServletRegistrationBean<>(servlet, "/collectionPlatform/ws/*");
    }
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema billsSchema) {
        ...
        wsdl11Definition.setLocationUri("/collectionPlatform/ws");
    ...
    public XsdSchema countriesSchema() {
        return new SimpleXsdSchema(new ClassPathResource("bills.xsd"));
    }
}
